...
const PastelIllustration = ({ className = "" }) => (
  ...
  >
    ...
    <g transform="translate(60,40)">
      ...
      <path
        d="M10 250 Q120 80 320 220 Q470 340 540 160"
        stroke="url(#g2)"
        strokeWidth="10"
        fill="none"
        strokeLinecap="round"
...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const containerBottomDoc =
        window.scrollY + containerRect.top + containerRect.height;
      ...
      <div className="sd-container">
        ...
        <div className="sd-grid">
          ...
          <div className="sd-main">
            {/* HERO */}
            <section className="sd-hero-wrapper">
